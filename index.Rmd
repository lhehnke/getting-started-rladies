...
6. Why I *personally* love R: Learning how to fail, finding out why (thanks to Google and Stack Overflow), trying again, failing better, learning from this experience (aka learning what to Google next time), and eventually having a moment of instant gratification when the code runs through (or not) `r emo::ji('pray')`
...
## But before you can start typing R code, you have to install the software first.
...
# It's your turn to install the software. <br> If you already did it, please help others who aren't there yet!


---

## Now that you have the prerequisites, let's continue with the extras: packages!
...
If you don't know how to do it, that's perfectly fine! We'll find out together.


1. Add 2 + 2 in R.

2. Try to calculate the square root of 16 (hint: *?sqrt*).
